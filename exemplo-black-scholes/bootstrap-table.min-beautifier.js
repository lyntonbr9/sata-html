...
!function(a) {
    ...
    o.prototype.initTable = function() {
        ...
        a.each(this.options.columns, function(c, d) {
            a.each(d, function(d, e) {
                e = a.extend({}, o.COLUMN_DEFAULTS, e),
    ...
    o.prototype.initToolbar = function() {
        ...
        g.push('<div class="pull-' + this.options.searchAlign + ' search">', c('<input class="form-control' + c(" input-%s", this.options.iconSize) + '" type="text" placeholder="%s">', this.options.formatSearch()), "</div>"),
        this.$toolbar.append(g.join("")),
        d = this.$toolbar.find(".search input"),
        d.off("keyup drop").on("keyup drop", function(a) {
            f.options.searchOnEnterKey && 13 !== a.keyCode || (clearTimeout(i),
        ...
        for (var k = this.pageFrom - 1; k < this.pageTo; k++) {
            ...
            a.each(this.header.fields, function(b, i) {
                ...
                if (x.visible) {
                    ...
                    q = x.radio ? "radio" : q,
                    j = [c(f.options.cardView ? '<div class="card-view %s">' : '<td class="bs-checkbox %s">', x["class"] || ""), "<input" + c(' data-index="%s"', k) + c(' name="%s"', f.options.selectItemName) + c(' type="%s"', q) + c(' value="%s"', n[f.options.idField]) + c(' checked="%s"', l === !0 || l && l.checked ? "checked" : void 0) + c(' disabled="%s"', !x.checkboxEnabled || l && l.disabled ? "disabled" : void 0) + " />", f.header.formatters[b] && "string" == typeof l ? l : "", f.options.cardView ? "</div>" : "</td>"].join(""),
                    ...
                    f.options.cardView && f.options.smartDisplay && "" === l && (j = '<div class="card-view"></div>')),
                    g.push(j)
                }
            }),
    ...
    o.prototype.initServer = function(b, c) {
        ...
        this.options.pagination && (g.pageSize = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize,
        g.pageNumber = this.options.pageNumber),
    ...
    o.prototype.updateByUniqueId = function(b) {
        var c;
        b.hasOwnProperty("id") && b.hasOwnProperty("row") && (c = a.inArray(this.getRowByUniqueId(b.id), this.options.data),
        -1 !== c && (a.extend(this.data[c], b.row),
        this.initSort(),
        this.initBody(!0)))
    }
    ,
